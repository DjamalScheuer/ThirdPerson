...
namespace JUTPS.FX
{
    ...
    public class ProceduralDrivingAnimation : JUTPSActions.JUTPSAction
    {
        ...
        protected virtual void DoProceduralDrivingAnimation(Vehicle Vehicle)
        {
            ...
            Vector3 LeftHintLocalPosition = Vector3.zero - Vector3.right * (3 - leftHint) + Vector3.forward * 10;
            Vector3 RightHintLocalPosition = Vector3.zero + Vector3.right * (3 + rightHint) + Vector3.forward * 10;
            ...
            //Apply Forward Lean
            anim.SpineInclination(Vector3.right, ForwardLeanWeight, Vehicle.AnimationWeights.FrontalLeanWeight);
            //Apply Sideways Lean
            anim.SpineInclination(Vector3.Lerp(Vector3.up, Vector3.forward, LeanDirection), SidewayLeanWeight, Vehicle.AnimationWeights.SideLeanWeight);
        }
    }
}
