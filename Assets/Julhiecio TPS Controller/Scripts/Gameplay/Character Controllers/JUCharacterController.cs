...
namespace JUTPS
{
    ...
    public class JUCharacterController : JUCharacterBrain
    {
        ...
        public virtual void ControllerInputs()
        {
            ...
            {
                if (AutoRun == false && WalkOnRunButton)
                {
                    IsRunning = true;
                }
                else
        ...
        protected virtual void Movement()
        {
            ...
            InAirMovementControl(AirInfluenceControll, JumpInert: true);
        ...
        void OnCollisionEnter(Collision other)
        {
            ...
            // >>> Delay of exit vehicle
            if (IsDriving == false)
            {
                DisablePhysicalDamageForSeconds();
                return;
            }
            if (AI.JUCharacterArtificialInteligenceBrain.TagMatches(other.gameObject.tag, PhysicalDamageIgnoreTags)) return;
            ...
            if (other.gameObject.TryGetComponent(out Rigidbody rbOtherPhysicObject))
            {
                ...
                if (physicalDamage > PhysicalDamageStartAt)
                {
                    ...
                    FX.HitMarkerEffect.HitCheck(other.gameObject.tag, "Player", other.contacts[0].point, physicalDamage);
                }
                // Do ragdoll
