    ...
    public class TPSControllerEditor : Editor
    {
        ...
        public void MovementSettingsVariables(JUCharacterController pl)
        {
            if (MovementSettings)
            {
                ...
                EditorGUILayout.PropertyField(serializedObject.FindProperty("LocomotionMode"));
                ...
                serializedObject.FindProperty("RunImpulse").boolValue = EditorGUILayout.ToggleLeft("  Run Impulse", pl.RunImpulse, JUTPSEditor.CustomEditorStyles.MiniLeftButtonStyle());
